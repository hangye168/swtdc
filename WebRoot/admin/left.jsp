			...
			<tr>
				<td width="182" valign="top">
					<div id="container">
						...
						<h1 class="type">
							<a href="javascript:void(0)">商家资料</a>
						</h1>
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/shanghu/shanghuinfo.jsp" target="main">商家资料</a>
								</li>
					...
					<c:if test="${sessionScope.userType==0}">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/shanghuMana.action" target="main">商家管理</a>
								</li>
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/userMana.action" target="main">会员管理</a>
								</li>
						...
						<h1 class="type">
							<a href="javascript:void(0)">菜品管理</a>
						</h1>
						<div class="content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
							...
							<ul class="MM">
							 ...
							 <c:if test="${sessionScope.userType==0}">
								<li>
									<a href="<%=path %>/catelogMana.action" target="main">菜品类别管理</a>
								</li>
								</c:if>
								
								 
								<li>
									<a href="<%=path %>/goodsManaNoTejia.action" target="main">菜品信息管理</a>
								</li>
					</ul>
						</div>
						</c:if>
					...
					<div class="content">
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/pinglunMana.action" target="main">评论管理</a>
							</li>
					...
					<h1 class="type">
						<a href="javascript:void(0)">销量管理</a>
					</h1>
					<div class="content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<ul class="MM">
							<li>
							<a href="<%=path %>/xiaoliang.action" target="main">销量查看</a>
							</li>
					 ...
					 <c:if test="${sessionScope.userType==3}">
						<h1 class="type">
						<a href="javascript:void(0)">送货单管理</a>
					</h1>
					<div class="content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/orderSonghuoList.action" target="main">送货单管理</a>
							</li>
					...
					<div class="content">
						...
						<ul class="MM">
						    <c:if test="${sessionScope.userType!=0 && sessionScope.userType!=3}">
							<li>
								<a href='#' onclick='javascript:window.parent.location="<%=path %>/logout.jsp"'>退出系统</a>
							</li>
							</c:if>
							...
							<c:if test="${sessionScope.userType==3}">
							<li>
								<a href='#' onclick='javascript:window.parent.location="<%=path %>/psylogout.jsp"'>退出系统</a>
							</li>
							</c:if>
						</ul>
					</div>
