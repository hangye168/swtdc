...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<h1><a href="#" title="商洛学院餐厅服务系统"><img src="<%=path%>/qiantai/images/logo.jpg" /></a></h1>
	...
	<img src="<%=path%>/qiantai/images/shpicture.jpg" class="sign-contu f-l" />
	
	<form action="<%=path %>/shanghuLogin.action" name="userLogin" method="post">
    <div class="sign-ipt f-l">
    	<p>商家名</p>
        <input type="text" name="userName"  placeholder="商家名" />
        <p>密码</p>
        ...
        <p>没有账号？请<a href="<%=path%>/qiantai/shanghu/shanghuReg.jsp">注册</a> </p>
